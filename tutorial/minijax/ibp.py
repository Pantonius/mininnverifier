...
from .core import InterpreterABC, ValueABC, neg, add, mul, matmul, relu, pop_interpreter, push_interpreter
...
class IBPInterpreter(InterpreterABC):
    def process_primitive(self, primitive, *args, **options):
        ...
        ibp_rule = ibp_rules[primitive]
        y_lb, y_ub = ibp_rule(*lbs, *ubs, **options)
